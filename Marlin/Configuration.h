...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -0.89  // Z probe to nozzle Z offset: -below (always!)
  ...
  #define Z_RAISE_BETWEEN_PROBINGS 8  // How much the Z axis will be raised when traveling from between next probing points.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 79.88, 3988.03,100.47095761381482}  // default steps per unit for Ultimaker
...
#define WITBOX
  ...
  #define Change_Filament_Target_Temp 210
  ...
  #define XY_TRAVEL_SPEED 6000     // X and Y axis travel speed between probes and Witbox movements, in mm/s
#endif
